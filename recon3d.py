...
class main():
	...
	def build_rotation_lookup_general(self):
		...
		T_up[:, :, :, :, 0:3, 3] = -n.array(self.par['xyz_up'])
		T_up[:, :, :, :, 0, 0] = 1.
		T_up[:, :, :, :, 1, 1] = 1.
		T_up[:, :, :, :, 2, 2] = 1.
		T_up[:, :, :, :, 3, 3] = 1.
		Tinv_up[:, :, :, :, 0:3, 3] = n.array(self.par['xyz_up'])
		Tinv_up[:, :, :, :, 0, 0] = 1.
		Tinv_up[:, :, :, :, 1, 1] = 1.
		Tinv_up[:, :, :, :, 2, 2] = 1.
		Tinv_up[:, :, :, :, 3, 3] = 1.
		T_lo[:, :, :, :, 0:3, 3] = -n.array(self.par['xyz_lo'])
		T_lo[:, :, :, :, 0, 0] = 1.
		T_lo[:, :, :, :, 1, 1] = 1.
		T_lo[:, :, :, :, 2, 2] = 1.
		T_lo[:, :, :, :, 3, 3] = 1.
		Tinv_lo[:, :, :, :, 0:3, 3] = n.array(self.par['xyz_lo'])
		Tinv_lo[:, :, :, :, 0, 0] = 1.
		Tinv_lo[:, :, :, :, 1, 1] = 1.
		Tinv_lo[:, :, :, :, 2, 2] = 1.
		Tinv_lo[:, :, :, :, 3, 3] = 1.
		T_th[:, :, :, :, 0:3, 3] = -n.array(self.par['xyz_th'])
		T_th[:, :, :, :, 0, 0] = 1.
		T_th[:, :, :, :, 1, 1] = 1.
		T_th[:, :, :, :, 2, 2] = 1.
		T_th[:, :, :, :, 3, 3] = 1.
		Tinv_th[:, :, :, :, 0:3, 3] = n.array(self.par['xyz_th'])
		Tinv_th[:, :, :, :, 0, 0] = 1.
		Tinv_th[:, :, :, :, 1, 1] = 1.
		Tinv_th[:, :, :, :, 2, 2] = 1.
		Tinv_th[:, :, :, :, 3, 3] = 1.
